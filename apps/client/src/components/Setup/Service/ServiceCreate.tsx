...
const ServiceCreate = forwardRef((props: SetupProps, ref) => {
  ...
  const [rowsData, setRowData] = React.useState<
    Record<string, Record<number, serviceColumns>>
  >({});
  ...
  useEffect(() => {
    props.gRPCClients.serviceGroupClient
      .getAll(new GetAllRequestService(), {})
      .then(
        (respServiceGrp) => {
          setData((prevState) => {
            return {
  ...
  function submit() {
    ...
    props.gRPCClients.serviceClient.store(storeRequest, {}).then(
      (r) => {
                              ...
                              column.id !== "name" && (
                                <TextField
                                  ...
                                  value={
                                    ...
                                    rowsData[
                                      table.getId()?.getValue() as string
                                    ][i][column.id as keyof serviceColumns]
                                  }
                                  onChange={(
                                    event: React.ChangeEvent<HTMLInputElement>
                                  ) => {
