  ...
  return (
    ...
    >
      ...
      <Route
        exact
        path="/setup/teams"
        render={() => <TeamMenuTable {...props} />}
      />
      <Route
        exact
        path="/setup/host_groups"
        render={() => <HostGroupsMenu {...props} />}
      />
      <Route exact path="/setup/users" render={() => <UserMenu {...props} />} />
      <Route exact path="/setup/hosts" render={() => <HostMenu {...props} />} />
      <Route
        exact
        path="/setup/services"
        render={() => <ServiceMenu {...props} />}
      />
      <Route
        exact
        path="/setup/properties"
        render={() => <PropertiesMenu {...props} />}
      />
      <Route
        exact
        path="/setup/rounds"
        render={() => <RoundsMenu {...props} />}
      />
      <Route
        exact
        path="/setup/service_groups"
        render={() => <ServiceGroupsMenu {...props} />}
      />
    </Box>
  );
}
