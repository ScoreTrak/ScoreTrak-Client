                  ...
                  <Grid item xs={7}>
                    <Card sx={{ maxWidth: 250 }}>
                      <CardMedia
                        ...
                        alt="Yahoo"
                        image={
                          "https://raw.githubusercontent.com/ubnetdef/lockdown-website/master/static/Yahoo.png"
                        }
                      />
                    </Card>
                  </Grid>
                  ...
                  <Grid item xs={6}>
                    <Card sx={{ maxWidth: 200 }}>
                      <CardMedia
                        ...
                        alt={"M&T Bank"}
                        image={
                          "https://raw.githubusercontent.com/ubnetdef/lockdown-website/master/static/M_T.png"
                        }
                      />
                    </Card>
                  </Grid>
