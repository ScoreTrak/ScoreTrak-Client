...
export default function Status(props: RanksProps) {
  ...
  const [highlightParentTeam, setHighlightParentTeam] =
  ...
  const data: Record<
    string,
    Record<string, SimpleService & { Address: string }>
  > = {};
                              ...
                              if (
                                ...
                                Object.keys(
                                  ...
                                  if (key === "Port") {
                                    msg +=
                                      ":" +
                                      data[name][column].Properties[key].Value;
                                  }
                                });
                              }
                            }
          ...
          <TableRow>
            <TableCell colSpan={dataKeysArray.length + 1}>
              ...
              >
                ...
                />
                {(token.isAValidToken() ||
                  props.currentPolicy.showAddresses?.value) && (
                  <FormControlLabel
                    className={classes.tableNavigator}
                    control={
                      <Switch
