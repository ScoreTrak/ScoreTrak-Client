...
import {
  GetRequest,
  GetResponse,
} from "@scoretrak/scoretrakapis/scoretrak/report/v1/report_pb";
    ...
    >
      {report && report.Round !== 0 ? (
        <Box
          m="auto"
          style={{
            height: handleFullScreen.active ? "100vh" : "85vh",
            width: "100%",
          }}
        >
          {(props.currentPolicy.showPoints?.value ||
          ...
          <Route
            ...
            render={() => (
              <Details
                ...
                genericEnqueue={props.genericEnqueue}
              />
            )}
          />
        </Box>
