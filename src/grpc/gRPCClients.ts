...
import { ServiceGroupServicePromiseClient } from "@buf/grpc_web_scoretrak_scoretrakapis/scoretrak/service_group/v1/service_group_grpc_web_pb";
...
import {
  DynamicConfigServicePromiseClient,
  StaticConfigServicePromiseClient,
...
export type GRPCClients = {
  ...
  competition: {
    v1: { competitionServicePromiseClient: CompetitionServicePromiseClient };
  };
  config: {
    v1: {
  ...
  host_group: {
    v1: { hostGroupServicePromiseClient: HostGroupServicePromiseClient };
  };
  policy: { v1: { policyServicePromiseClient: PolicyServicePromiseClient } };
  property: {
    v1: { propertyServicePromiseClient: PropertyServicePromiseClient };
  };
  ...
  service_group: {
    v1: { serviceGroupServicePromiseClient: ServiceGroupServicePromiseClient };
  };
...
export const gRPCClients: GRPCClients = {
  auth: {
    v1: {
      authServicePromiseClient: new AuthServicePromiseClient(
        serverAddress,
        null,
        options
      ),
  ...
  check: {
    v1: {
      checkServicePromiseClient: new CheckServicePromiseClient(
        serverAddress,
        null,
        options
      ),
  ...
  competition: {
    v1: {
      competitionServicePromiseClient: new CompetitionServicePromiseClient(
        serverAddress,
        null,
        options
      ),
  ...
  config: {
    v1: {
      dynamicConfigServicePromiseClient: new DynamicConfigServicePromiseClient(
        serverAddress,
        null,
        options
      ),
      staticConfigServicePromiseClient: new StaticConfigServicePromiseClient(
        serverAddress,
        null,
        options
      ),
  ...
  host: {
    v1: {
      hostServicePromiseClient: new HostServicePromiseClient(
        serverAddress,
        null,
        options
      ),
  ...
  host_group: {
    v1: {
      hostGroupServicePromiseClient: new HostGroupServicePromiseClient(
        serverAddress,
        null,
        options
      ),
  ...
  policy: {
    v1: {
      policyServicePromiseClient: new PolicyServicePromiseClient(
        serverAddress,
        null,
        options
      ),
  ...
  property: {
    v1: {
      propertyServicePromiseClient: new PropertyServicePromiseClient(
        serverAddress,
        null,
        options
      ),
  ...
  report: {
    v1: {
      reportServicePromiseClient: new ReportServicePromiseClient(
        serverAddress,
        null,
        options
      ),
  ...
  round: {
    v1: {
      roundServicePromiseClient: new RoundServicePromiseClient(
        serverAddress,
        null,
        options
      ),
  ...
  service: {
    v1: {
      serviceServicePromiseClient: new ServiceServicePromiseClient(
        serverAddress,
        null,
        options
      ),
  ...
  service_group: {
    v1: {
      serviceGroupServicePromiseClient: new ServiceGroupServicePromiseClient(
        serverAddress,
        null,
        options
      ),
  ...
  team: {
    v1: {
      teamServicePromiseClient: new TeamServicePromiseClient(
        serverAddress,
        null,
        options
      ),
  ...
  user: {
    v1: {
      userServicePromiseClient: new UserServicePromiseClient(
        serverAddress,
        null,
        options
      ),
