...
export class Host extends jspb.Message {
  ...
  setId(value?: pkg_proto_proto_v1_uuid_pb.UUID): Host;
  hasId(): boolean;
  clearId(): Host;
  ...
  getHostGroupId(): pkg_proto_proto_v1_uuid_pb.UUID | undefined;
  setHostGroupId(value?: pkg_proto_proto_v1_uuid_pb.UUID): Host;
  hasHostGroupId(): boolean;
  clearHostGroupId(): Host;

  getTeamId(): pkg_proto_proto_v1_uuid_pb.UUID | undefined;
  setTeamId(value?: pkg_proto_proto_v1_uuid_pb.UUID): Host;
  hasTeamId(): boolean;
  clearTeamId(): Host;
  ...
  setServicesList(value: Array<pkg_proto_service_v1_service_pb.Service>): Host;
...
export namespace Host {
  export type AsObject = {
    ...
    address: string,
    hostGroupId?: pkg_proto_proto_v1_uuid_pb.UUID.AsObject,
    teamId?: pkg_proto_proto_v1_uuid_pb.UUID.AsObject,
