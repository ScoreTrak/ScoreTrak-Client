...
export class Team extends jspb.Message {
  ...
  setId(value?: pkg_proto_proto_v1_uuid_pb.UUID): Team;
  hasId(): boolean;
  clearId(): Team;
  ...
  setHostsList(value: Array<pkg_proto_host_v1_host_pb.Host>): Team;
  clearHostsList(): Team;
  ...
  setUsersList(value: Array<pkg_proto_user_v1_user_pb.User>): Team;
  clearUsersList(): Team;
