...
export class Property extends jspb.Message {
  getServiceId(): pkg_proto_proto_v1_uuid_pb.UUID | undefined;
  setServiceId(value?: pkg_proto_proto_v1_uuid_pb.UUID): Property;
...
export namespace Property {
  export type AsObject = {
    serviceId?: pkg_proto_proto_v1_uuid_pb.UUID.AsObject,
    key: string,
...
export class GetByServiceIDKeyRequest extends jspb.Message {
  getServiceId(): pkg_proto_proto_v1_uuid_pb.UUID | undefined;
  setServiceId(value?: pkg_proto_proto_v1_uuid_pb.UUID): GetByServiceIDKeyRequest;
  hasServiceId(): boolean;
...
export class GetAllByServiceIDRequest extends jspb.Message {
  getServiceId(): pkg_proto_proto_v1_uuid_pb.UUID | undefined;
  setServiceId(value?: pkg_proto_proto_v1_uuid_pb.UUID): GetAllByServiceIDRequest;
  hasServiceId(): boolean;
...
export class DeleteRequest extends jspb.Message {
  getServiceId(): pkg_proto_proto_v1_uuid_pb.UUID | undefined;
  setServiceId(value?: pkg_proto_proto_v1_uuid_pb.UUID): DeleteRequest;
  hasServiceId(): boolean;
