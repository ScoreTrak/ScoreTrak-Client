...
export class HostGroup extends jspb.Message {
  ...
  setId(value?: pkg_proto_proto_v1_uuid_pb.UUID): HostGroup;
  hasId(): boolean;
  clearId(): HostGroup;
  ...
  getHosts(): pkg_proto_host_v1_host_pb.Host | undefined;
  setHosts(value?: pkg_proto_host_v1_host_pb.Host): HostGroup;
  hasHosts(): boolean;
...
export namespace HostGroup {
  export type AsObject = {
    ...
    hosts?: pkg_proto_host_v1_host_pb.Host.AsObject,
  }
}
