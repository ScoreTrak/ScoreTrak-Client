...
export class ServiceGroup extends jspb.Message {
  ...
  setId(value?: pkg_proto_proto_v1_uuid_pb.UUID): ServiceGroup;
  hasId(): boolean;
  ...
  setServicesList(value: Array<pkg_proto_service_v1_service_pb.Service>): ServiceGroup;
...
export class StoreResponse extends jspb.Message {
  getId(): pkg_proto_proto_v1_uuid_pb.UUID | undefined;
  setId(value?: pkg_proto_proto_v1_uuid_pb.UUID): StoreResponse;
  hasId(): boolean;
...
export class RedeployRequest extends jspb.Message {
  getId(): pkg_proto_proto_v1_uuid_pb.UUID | undefined;
  setId(value?: pkg_proto_proto_v1_uuid_pb.UUID): RedeployRequest;
  hasId(): boolean;
