...
import {Link as RouterLink, NavigateOptions, To, useNavigate} from "react-router-dom"
        ...
        <AppBar position="static">
            <Container maxWidth={"xl"}>
                <Toolbar className={classes.toolbar}>
                    ...
                    { !token.isAValidToken() ?
                        <Button href={"/auth/sign_in"} color={"inherit"}>Sign In</Button>
                        :
                        <>
...

                    {
                        ...
                        >
                            ...
                            <MenuItem onClick={navigateSettings("/host_groups")}>Host Groups</MenuItem>
                            <MenuItem onClick={navigateSettings("/services")}>Services</MenuItem>
                            <MenuItem onClick={navigateSettings("/service_groups")}>Service Groups</MenuItem>
                            <MenuItem onClick={navigateSettings("/properties")}>Properties</MenuItem>
