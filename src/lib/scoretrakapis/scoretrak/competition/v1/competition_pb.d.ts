...
export class Competition extends jspb.Message {
  ...
  setHostGroupsList(
    value: Array<scoretrak_host_group_v1_host_group_pb.HostGroup>
  ): Competition;
  ...
  setServiceGroupsList(
    value: Array<scoretrak_service_group_v1_service_group_pb.ServiceGroup>
  ): Competition;
  ...
  setPropertiesList(
    value: Array<scoretrak_property_v1_property_pb.Property>
  ): Competition;
