...
export function useDynamicConfigQuery() {
  ...
  return useQuery<DynamicConfig | undefined, grpcWeb.RpcError>(["config", "dynamic"], fetchDynamicConfig)
}
...
export function useStaticConfigQuery() {
  ...
  return useQuery<string, grpcWeb.RpcError>(["config", "static"], fetchStaticConfig)
}
...
export function useDynamicConfigMutation() {
  ...
  return useMutation<UpdateResponse, grpcWeb.RpcError, DynamicConfig>(updateDynamicConfig, {
    onError: (error) => {
